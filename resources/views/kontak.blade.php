                ...
                <form class="w-full max-w-lg">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full input input-bordered input-warning"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <textarea
                                class=" no-resize appearance-none block w-full textarea textarea-warning resize-none"
                                id="message"></textarea>
                    ...
                    <div class="md:flex md:items-center">
                        <div class="md:w-1/3">
                            <button
                                class="btn btn-warning bg-[#FFE200] font-extrabold text-black hover:bg-[#c79305] border-none duration-500"
                                type="button">
                                Send
                            </button>
                        </div>
                ...
                <div class="p-6 xl:col-span-1">
                    <div class="grid gap-4 md:grid-cols-1">
                        <div class="grid content-center gap-4">
                            <div class="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-1 xl:text-left"
