      ...
      <div class="py-10" data-aos="zoom-out-up" data-aos-duration="1000">
        <div class="flex flex-wrap justify-around">
          <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/2 p-4">
            <div class="card lg:w-100 rounded-none bg-white border-solid border-4 border-white duration-300 hover:scale-105 ease-in-out hover:shadow-xl hover:shadow-[#8d7c00] duration-300">
              ...
              <div class="card-body text-black ">
                ...
                <div class="card-actions justify-end">
                  <button class="btn btn-warning shadow-xl font-extrabold bg-[#FFE200] border-none">Read More...</button>
                </div>
              </div>
            </div>
          </div>
